      ...
      <Navbar />
        ...
        >
          <div className="text-2xl sm:text-3xl font-bold dark:text-white text-center">
            Learn <span className="text-blue-400">Web Accessibility</span> with Practical Examples
          </div>
          <Link href="https://mainakkaniam.hashnode.dev/web-accessibility-for-beginners" id="blog">
